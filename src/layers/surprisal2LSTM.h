...
*
*   Implementation of surprisal2LSTM layer
*
*/

#ifndef _surprisal2LSTM_H_
#define _surprisal2LSTM_H_
...
template <typename T>
class surprisal2LSTM : public Timelayer<T> {
	...
	public:
		...
		/* main constructor */
		surprisal2LSTM ( size_t _M, size_t _N, size_t _B,
						 size_t _S ) :
...
#define o_gates 1 * N * s(t, g).rows()
		...
		virtual void backward ( bool apply_dropout, size_t t ) {
			...
			//carry - y state
			cu_elementwise_surprisal_lstm_backward20 ( g ( t - 1, p ).cu_data,
		...
		/* optional */
		/* copy constr */
		//surprisal2LSTM( const surprisal2LSTM& src) : Timelayer(src.M, src.N, src.B, src.S)  { }
		
		/* assignent operator */
		//surprisal2LSTM& operator=( const surprisal2LSTM& src) { Timelayer::operator=(src); return *this; }
