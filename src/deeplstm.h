...
//#include <layers/cu_lstm.h>
	...
	#include <layers/surprisalALSTM.h>
	#include <layers/surprisalALSTM_stoch_lane.h>
	#include <layers/surprisalLSTM.h>
	#include <layers/surprisalrLSTM_do.h>
	#include <layers/surprisal2LSTM.h>
	#include <layers/surprisalLSTMBASE.h>
	#include <layers/sparseLSTM.h>
	#include <layers/surprisalAAttLSTM.h>
	#include <layers/peepLSTM.h>
...
class DeepLSTM {
	...
	public:
		...
		DeepLSTM ( size_t _M, size_t _N, size_t _B, size_t _S, size_t _D,
			...
			//D LSTM layers
			layers.push_back ( new surprisalLSTM<MatrixType> ( _M, _N, _B, _S ) );
			
			for ( size_t d = 1; d < D; d++ )
				layers.push_back ( new LSTM<MatrixType> ( _N, _N, _B, _S ) );
				
			//+ 1 softmax layer
			// layers.push_back ( new Identity<MatrixType> ( _M, _M, _B, _S ) );
